...
<template>
  <section
    ...
    aria-label="Preview">
    <div
      class="print mx-auto flex h-[297mm] w-[210mm] items-center justify-center border border-hl text-resume shadow-lg print:m-0 print:border-none print:shadow-none">
      <!-- Page content -->
